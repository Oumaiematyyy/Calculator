...
- **Swing** pour l'interface graphique (JFrame, JPanel, JButton, JTextField)
- **AWT** pour les événements (ActionListener) et la mise en page (GridLayout)
- **Git/GitHub** pour le versionnement

## Comment lancer le projet

### Prérequis
- Java JDK installé (version 8 minimum)
- Un IDE (IntelliJ, Eclipse, VS Code) ou le terminal
